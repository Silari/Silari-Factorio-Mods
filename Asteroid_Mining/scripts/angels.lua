...
function setmixed2(processmixed) --will rename back to setmixed IF I end up adding these in. I doubt it though.
    ...
    if mods["bobplates"] and mods["bobmodules"] and mods["bobelectronics"] then
        processmixed.results = { -- 2330 chunks expected
            {
              amount = 1,
              name = "iron-ore-chunk",
              probability = 0.1,
    ...
    elseif mods["bobplates"] and mods["bobelectronics"] then
        processmixed.results = { -- 3350 chunks expected
            {
              amount = 1,
              name = "iron-ore-chunk",
              probability = 0.1,
    ...
    elseif mods["bobplates"] and mods["bobmodules"] then
        processmixed.results = { -- 6050 chunks expected
            {
              amount = 4,
              name = "iron-ore-chunk",
              probability = 0.4,
    ...
    elseif mods["bobmodules"] and mods["bobelectronics"] then
        processmixed.results = { -- 2600 chunks expected
            {
              amount = 4,
              name = "iron-ore-chunk",
              probability = 0.2,
    ...
    elseif mods["bobplates"] then
        processmixed.results = { -- 6110 chunks expected
            {
              amount = 4,
              name = "iron-ore-chunk",
              probability = 0.45,
